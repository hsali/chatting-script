    ...
    posts: {
        "far4p4m9njy98mspcnh7fbqish": {
            "7be7n47oqpb9tk41zu8encipey": {
                ...
                "posts": {
                    ...
                    "1egwbw3gf7dwjp5b3sm7gmq6xh": {
                        ...
                        "props": {},
                        "hashtags": "",
                        "file_ids": ["tgoz6efd6tnhtftbpkzxd9f9ny"],
                        "pending_post_id": ""
                    },
                    ...
                    "7j8mehz7zjdg5q9nw15y5eg89a": {
                        ...
                        "props": {},
                        "hashtags": "",
                        "file_ids": ["dkik61m3d3nn3kj73gguqm8thh"],
                        "pending_post_id": ""
                    },
                    ...
                    "gw4aa6ofx7dcirswto4ijfcmiw": {
                        ...
                        "props": {},
                        "hashtags": "",
                        "file_ids": ["fx8qti1txpgapjq95x4wy4n1tr"],
                        "pending_post_id": ""
                    },
                    ...
                    "w4f8en4wotrciq45zf33f6sp5y": {
                        ...
                        "props": {},
                        "hashtags": "",
                        "file_ids": ["54yiqho6b7bnfb141kdzz3gmcc"],
                        "pending_post_id": ""
                    },
            ...
            "tohoobbjpf88pft5upfjdnjx5a": {
                "order": ["qpf5ny1j77rqiect4ca6rc9eby", "ge9kt74rfi89zn84fbfxh5zure", "746xh146otrbte5f95hg41npsh", "bnx4xjd4mjbsidnta89obm7a8a", "bcmb51ajn3nttkpq1mi738cmsh", "u6s9igui93f5dx4ajkh1wicchy", "hri39o4h8fndfknnjoz7j8fhrw"],
                "posts": {
                    ...
                    "ge9kt74rfi89zn84fbfxh5zure": {
                        ...
                        "props": {},
                        "hashtags": "",
                        "file_ids": ["typi15wmcpdcucwdkwztgu6rnc"],
                        "pending_post_id": ""
                    },
        ...
        "kgrwcfe9opdmdb6jc4b1jn4hhh": {
            "qexhwiihsibumghidgg5uhuyzh": {
                "order": ["a87rbrs1cprrxcg5i87kg49oew", "3iuheu9gi7f9xby5eu73x9jb8o", "sgc384f19jngubzzizt96x474r"],
                "posts": {
            ...
            "4st579qwa3fxzpaugqs6ibnf5a": {
                "order": ["wibee5z7xj898y8cbn7antk81y", "8x5aryo74fyyudb46yzdz79ryo", "4pc41q9o1igutkeen64h6z7ygo"],
                "posts": {
        ...
        "sqeb57bc7bgajj4p4mb4a1q54o": {
            "n1wyjgkcjpbejktr6n7ega4g7h": {
                "order": ["om5scq49fpn9mjxpgxizcec89c", "1j3jcefei3rjf8attr13agtg1h", "r3gpi5mjqtyifm1x7sywxds73a", "7urzny1fx7rz5mfw95f18ke3xo", "x3s6kxtqo7byugyxrdy5mocq7c"],
                "posts": {
            ...
            "rincgswz1tbz8j7yhxrbjpkgsw": {
                "order": ["j5id8un9aigrp8ig75qumutyca", "qjhoyictxi8mzcbuookntan18e", "dz1uumeitj8q8mp16ktfwz7cqa", "t5rt7m5tc3ge8xo4gpcxom8kye", "gd9tw1tjhibujqtpbr3d1xseho", "c5dqxo7up7r33y4yw6w179h5kw", "3wjxjmw3hpdfzk3rux8zdbe5ao", "i1gzmc8j8bgjjeq7punygmufar", "izfnoyyxiidfm8upffhbqfcouw"],
                "posts": {
...
function showPosts(posts) {
    try {
        var postData = posts;
        var postOrder = postData.order;
        var revPostsOrder = postOrder.reverse();
        var postItems = postData.posts;
        var i = 0,
            userId = void 0,
            time = void 0;
        ...
        var _loop = function _loop() {
            var message = postItems[revPostsOrder[i]].message;
...
function showPostsAfterpost() {
    try {
        var after_posts = JSON.parse(getPostsAfterPost(activeChatDetail.team.id, activeChatDetail.channel.id, lastPostId));
        var after_orders = after_posts.order;
        var rev_afterorders = after_orders.reverse();
        var postItems = after_posts.posts;
        var i = 0;
        console.log("posts" + postItems);
        ...
        var _loop2 = function _loop2() {
            var message = postItems[rev_afterorders[i]].message;
            setTimeout(function () {
                console.log(message);
                messenger.recieve(message);
            }, i * 500 + 1000);
...
//============Users=================
function getUsersInChannel(teamId, channelId) {
    ...
    _createClass(Messenger, [{
        ...
        value: function recieve() {
            ...
            if (this.validate(text)) {
                ...
                this.messageList.push(_message2);

                this.onRecieve(_message2);
            }
        }
    }, {
        key: "delete",
